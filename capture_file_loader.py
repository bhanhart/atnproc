...
class CaptureFileLoader:
    """Find the latest capture files using a today-then-yesterday strategy.
    ...
    will be provided for processing.
    """
    ...
    def load_files(self, directories: list[Path]) -> None:
        ...
        file_loader = FileLoader(directories)
        ...
        self._files.extend(file_loader.files)
